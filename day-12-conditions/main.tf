...
#   validation {
#     condition = var.aws_region == "ap-south-1" || var.aws_region == "ap-southeast-1"
#     error_message = "The variable 'aws_region' must be one of the following regions: ap-south-1, ap-southeast-1"
#   }
# }
